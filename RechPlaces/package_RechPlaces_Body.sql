...
AS
    ...
    PROCEDURE RecupererFilms(complexe IN VARCHAR2, acteursInput IN VARCHAR2, realisateursInput IN VARCHAR2, genresInput IN VARCHAR2, titreInput IN VARCHAR2, popularite IN VARCHAR2, popInput IN NUMBER, perennite IN VARCHAR2, perInput IN NUMBER)
    IS      
        split apex_t_varchar2;
        requete VARCHAR2(4096);
        characterPop CHAR(1);
    ...
    BEGIN   
        ...
        IF (popularite = 'Inf') THEN
            characterPop := '<';
        ELSIF(popularite = 'Sup') THEN
            characterPop := '>';
        ELSIF(popularite = 'Egale') THEN
            characterPop := '=';
        END IF;
            
        IF (perennite = 'Inf') THEN
            characterPer := '<';
        ELSIF(perennite = 'Sup') THEN
            characterPer := '>';
        ELSIF(perennite = 'Egale') THEN
            characterPer := '=';  
        END IF;
        ...
        requete := requete || ')
            ...
            AND c.IdCerti = f.Certification
            AND p.IdPoster = f.Poster 
            AND av.ComplexePopularite ' || characterPop || ' ' || popInput || '
            AND av.ComplexePerenite ' || characterPer || ' ' || perInput || '
            ORDER BY av.ComplexePopularite DESC, ComplexePerenite DESC, f.IdFilm';
    ...
    PROCEDURE RecupererFilms(complexe IN VARCHAR2, acteursInput IN VARCHAR2, realisateursInput IN VARCHAR2, genresInput IN VARCHAR2, titreInput IN VARCHAR2, popularite IN VARCHAR2, popInput IN NUMBER) IS
    split apex_t_varchar2;
        requete VARCHAR2(4096);
        characterPop CHAR(1);
    ...
    PROCEDURE RecupererFilms(complexe IN VARCHAR2, acteursInput IN VARCHAR2, realisateursInput IN VARCHAR2, genresInput IN VARCHAR2, titreInput IN VARCHAR2, perennite IN VARCHAR2, perInput IN NUMBER) IS
    split apex_t_varchar2;
        requete VARCHAR2(4096);
        characterPer CHAR(1);
