...
DECLARE
	...
	FOR indx IN 1 .. l_col.count LOOP
        ...
        '|| l_col(indx) ||'_min, '|| l_col(indx) ||'_max, '|| l_col(indx) ||'_moy, '|| l_col(indx) ||'_ecarttype, '|| l_col(indx) ||'_medianne, '|| l_col(indx) ||'_count, '|| l_col(indx) ||'_q95, '|| l_col(indx) ||'_q995, '|| l_col(indx) ||'_nbnull, '|| 
	...
	UNPIVOT (value for aliases IN (actors_min,actors_max,actors_ecarttype,actors_medianne,actors_count,actors_q95,actors_q995,
                                    ide_actors_min,ide_actors_max,ide_actors_moy,ide_actors_ecarttype,ide_actors_medianne,ide_actors_count,ide_actors_q95,ide_actors_q995,
